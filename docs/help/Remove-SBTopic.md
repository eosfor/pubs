...
## SYNOPSIS
Removes Service Bus SBTopic operations.

## SYNTAX

```
Remove-SBTopic [[-Topic] <String>] [-Force] [-ServiceBusConnectionString <String>] [-Context <SBContext>]
 [-NoContext] [-IgnoreCertificateChainErrors] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

## DESCRIPTION
Use this cmdlet to perform Service Bus management or data-plane tasks for Remove-SBTopic.
...
Runs Remove-SBTopic with default parameters.
