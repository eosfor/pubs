...
## SYNOPSIS
Removes Service Bus SBAuthorizationRule operations.
...
## DESCRIPTION
Use this cmdlet to perform Service Bus management or data-plane tasks for Remove-SBAuthorizationRule.
